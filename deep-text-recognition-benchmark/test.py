...
def validation(model, criterion, evaluation_loader, converter, opt):
    ...
    n_incorrect = length_of_data - n_correct

    return valid_loss_avg.val(), accuracy, norm_ED, preds_str, confidence_score_list, labels, infer_time, length_of_data, n_incorrect
